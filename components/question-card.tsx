...
export function QuestionCard({
  ...
  const progressValue = ((index + 1) / TOTAL_QUESTIONS) * 100;
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center px-6 py-24">
      <div className="w-full max-w-[900px]">
        ...
        <div className="mb-10">
          <Progress value={progressValue} label={`Question ${index + 1} of ${TOTAL_QUESTIONS}`} />
        </div>
          ...
          >
            <GlassPanel className="p-8 sm:p-12">
              ...
              <div className="mt-8">
                ...
                />
                {/* Kept visible even after typing starts (unlike the
                    placeholder, which disappears) so there's always a
                    concrete example of the kind of answer we're looking for. */}
                <p
